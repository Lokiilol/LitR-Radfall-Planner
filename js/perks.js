                ...
                ranked: [
                    {
                        ...
                        level: 0,
                        str: 2,
                        description: 'Thanks to practice and conditioning your heavy weapons do 15% more damage plus an additional 0.5% per level, and degrade less frequently.'
                    },
                    {
                        rank: 2,
                        level: 12,
                    ...
                    },
                    {
                        ...
                        level: 70,
                        str: 6,
                        description: 'Your heavy weapons do 55% more damage, and degrade less frequently.You do 55% more damage with heavy guns.'
                    }
                ]
            },
            {
                ...
                ranked: [
                    {
                        ...
                        level: 0,
                        str: 3,
                        description: 'Swing for the fences! You do 10% more damage, plus an additional 1% damage per level with unarmed and blunt melee weapons.'
                    },
                    {
                        rank: 2,
                        level: 12,
                ...
                ranked: [
                    {
                        ...
                        level: 0,
                        str: 4,
                        description: 'Fire up the forge and gain access to Rank 1 power armor mods.'
                    },
                    {
                        rank: 2,
                        level: 16,
            ...
            },
            {
                ...
                ranked: [
                    ...
                    },
                    {
                        ...
                        level: 21,
                        str: 9,
                        description: 'Reduce incoming fall damage by 1% for each 1% radiation damage you\'ve taken.'
                    },
                    {
                        rank: 3,
                        level: 42,
            ...
            },
            {
                ...
                ranked: [
                    ...
                    },
                    {
                        ...
                        level: 50,
                        str: 12,
                        description: 'CURRENTLY BUGGED TEXT AND RANK IN GAME'
                    }
                ]
            }
        ]
                ...
                ranked: [
                    {
                        ...
                        level: 0,
                        per: 2,
                        description: 'Keep your distance long and your kill-count high! Your manual-action rifles and shotguns do 10% plus 0.5% damage per level, and degrade less frequently.'
                    },
                    {
                        rank: 2,
                        level: 12,
                ...
                ranked: [
                    {
                        ...
                        level: 0,
                        per: 3,
                        description: 'Your nimble fingers allow you to pick Advanced locks, and bypass Novice locks.'
                    },
                    {
                        rank: 2,
                        level: 7,
                        per: 4, 
                        description: 'You can pick Expert locks, and bypass Advanced Locks.'
                    },
                    {
                        rank: 3,
                        level: 18,
                        per: 5,
                        description: 'You can pick Master locks, and bypass Expert locks.'
                    },
                    {
                        rank: 4,
                        level: 41,
                        per: 6, 
                        description: 'You can bypass Master locks.'
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                ranked: [
                    ...
                    },
                    {
                        ...
                        level: 28,
                        per: 10,
                        description: 'Your attacks with ballistic weapons ignore 15% of your target\'s armor, and in V.A.T.S. you can target an enemy\'s body parts that are blocked by cover, with a large decrease in accuracy.'
                    },
                    {
                        rank: 3,
                        level: 52,
                ...
                ranked: [
                    {
                        ...
                        level: 0,
                        per: 10,
                        description: 'It\'s all about focus. You have improved control and can hold your breath longer when aiming with scopes, and increased range.'
                    },
                    {
                        rank: 2,
                        level: 26,
                        per: 11,
                        description: 'When aiming with scopes, non-automatic rifles have increased range.'
                    },
                    {
                        rank: 3,
                        level: 50,
            ...
            },
            {
                ...
                ranked: [
                   ...
                   },
                   {
                       ...
                       description: 'Drinking water restores even more Health, and you swim 25% faster.'
                   }
                ]
            },
            {
                ...
                ranked: [
                    {
                        ...
                        level: 0,
                        cha: 10,
                        description: 'With your gun, aim at any human opponent of your level or below and gain a chance to pacify them, while higher level opponents will deal 10% less damage to you.'
                    },
                    {
                        rank: 2,
                        level: 23,
                        cha: 11,
                        description: 'When you successfully pacify someone, you can incite them to attack. Higher level opponents now deal 20% less damage to you.'
                    },
                    {
                        rank: 3,
                        level: 38,
                        cha: 12,
                        description: 'Your simple presence will eventually scare the heck out of humanoid enemies, and when you successfully pacify someone, you can give them specific commands.'
                    }
                ]
            }
        ]
                ...
                ranked: [
                    {
                        ...
                        level: 0,
                        int: 2,
                        description: 'The bigger the boom, the better! You do 10% more damage plus an additional 1% per level with explosives.'
                    },
                    {
                        rank: 2,
                        level: 10,
                ...
                ranked: [
                    {
                        ...
                        level: 0,
                        agi: 2,
                        description: 'Channel the spirit of the Old West! Your pistols do 10% plus an additional 0.5% per level more damage, and degrade less frequently.'
                    },
                    {
                        rank: 2,
                        level: 12,
                    ...
                    },
                    {
                        ...
                        level: 30,
                        agi: 4,
                        description: 'Your pistols do 35% more damage, degrade less frequently, and attacks on arms have a chance to disarm your target.'
                    },
                    {
                        rank: 4,
                        level: 50,
                        agi: 5,
                        description: 'Your pistols do 45% more damage, degrade less frequently, and attacks with on legs have a chance to knock your target down.'
                    },
                    {
                        rank: 5,
                        level: 70,
                ...
                ranked: [
                    {
                        ...
                        level: 0,
                        agi: 4,
                        description: 'Become whisper, become shadow. You are 20% harder to detect while sneaking while not overencumbered.'
                    },
                    {
                        rank: 2,
                        level: 7,
                        agi: 5,
                        description: 'You are now 30% harder to detect while sneaking while not overencumbered.'
                    },
                    {
                        rank: 3,
                        level: 16,
                        agi: 6,
                        description: 'You are now 40% harder to detect while sneaking while not overencumbered.'
                    },
                    {
                        rank: 4,
                        level: 32,
                        agi: 7,
                        description: 'You are now 50% harder to detect while sneaking, and running no longer adversely affects stealth while not overencumbered.'
                    },
                    {
                        rank: 5,
                        level: 38,
                        agi: 8,
                        description: 'Engaging stealth causes distant enemies to lose you while not overencumbered.'
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                ranked: [
                    ...
                    },
                    {
                        ...
                        level: 28,
                        agi: 7,
                        description: 'While sprinting, you dodge a percent of damage equal to twice your agility.'
                    },
                    {
                        rank: 3,
                        level: 52,
                        agi: 8,
                        description: 'While sprinting, you dodge a percent of damage equal to three times your agility.'
                    }
                ]
            },
            {
                ...
                ranked: [
                    {
                        ...
                        level: 0,
                        lck: 2,
                        description: 'Rigorous training or just dumb luck? Your semi-auto rifles, full-auto rifles and shotguns do 10% more damage, plus an additional 0.5% damage per level, and degrade less frequently.'
                    },
                    {
                        rank: 2,
                        level: 18,
                        lck: 3,
                        description: 'Your semi-auto rifles, full-auto rifles and shotgunss do 25% more damage, degrade more slowly, and have a 7% chance to gain a free magazine when you fire the last bullet in your magazine.'
                    },
                    {
                        rank: 3,
                        level: 24,
                        lck: 4,
                        description: 'Your semi-auto rifles, full-auto rifles and shotguns do 35% more damage and degrade less frequently.'
                    },
                    {
                        rank: 4,
                        level: 50,
                        lck: 5,
                        description: 'Your semi-auto rifles, full-auto rifles and shotguns do 45% more damage, degrade less frequently, and have a 14% chance to gain a free magazine when you fire the last bullet in your magazine.'
                    },
                    {
                        rank: 5,
                        level: 74,
                        lck: 6,
                        description: 'Your automatic weapons now do 55% more damage, and have a greater chance to stagger opponents.'
                    }
                ]
            },
            {
